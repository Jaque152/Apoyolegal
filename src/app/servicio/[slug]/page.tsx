        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={90} className="mt-12">
              <h2 className="text-[1.4rem] text-ink">Qué incluye</h2>
            ...
            <Reveal delay={140} className="mt-12 grid gap-px sm:grid-cols-3">
              ...
              <InfoTile
                ...
                label="Modalidad"
                value="Presencial y remota"
              />
              <InfoTile
                icon={<ShieldCheck className="h-4 w-4" strokeWidth={1.4} />}
                label="Confidencialidad"
                value="Acuerdo NDA disponible"
              />
            </Reveal>

            <Reveal delay={180} className="mt-12 border-l-2 border-brass pl-6">
              <p className="text-[0.95rem] leading-relaxed text-forest-soft">
                Después del pago recibes un correo con la lista exacta de
                documentos que debes enviarnos y el nombre del abogado asignado
                a tu asunto. Si tu caso resulta más simple de lo previsto, te
          ...
          <div className="lg:col-span-5">
            <Reveal delay={80}>
              <div className="sticky top-28 border border-forest/15 bg-card p-7 shadow-[8px_8px_0_0_hsl(var(--forest)/0.08)] md:p-8">
                <p className="eyebrow text-brass">Honorarios</p>
                ...
                <p className="mt-6 text-[0.78rem] leading-relaxed text-forest/60">
                  Pago con tarjeta o transferencia SPEI. Factura CFDI 4.0 emitida
                  en 24 horas.
                </p>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-8xl px-5 py-16 md:px-10 md:py-20 lg:px-14">
            <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
              <h2 className="text-[1.6rem] text-ink">
                También de {category?.shortName.toLowerCase()}
              </h2>
              <Link
                href={`/servicios/${service.category}`}
